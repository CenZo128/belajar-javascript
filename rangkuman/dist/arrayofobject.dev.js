...
var resultStudents = [["Vincent", 3.21, true], ["Stella", 3.05, true], ["Fendy", 3.75, true]]; // console.log(convertToArray(students))
...
var student = {
  ...
  drink: function drink(drinks) {
    return "Saya minum ".concat(drinks);
  }
};
